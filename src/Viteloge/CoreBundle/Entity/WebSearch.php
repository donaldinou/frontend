...
class WebSearch
{
     ...
     * @var jsonarray
     *
     * @ORM\Column(name="cached_properties", type="jsonarray", nullable=true)
     */
     ...
     *
     * @param \jsonarray $cachedProperties
     * @return WebSearches
     */
    public function setCachedProperties(\jsonarray $cachedProperties)
    {
